...
<html>
    ...
    <body>
        ...
        <main>
            <div>
                <img src="/public/rainier/media/images/rainier_mountainbiking_guide_opt.jpg" alt="Mountain Biking Guide" title="Ryan Layton">
        ...
        <aside>
            <div>
                <h3>Packages:</h3>
                <a href="/public/rainier/activities/mountain_biking.php" title="Mountain Biking Mount Rainier">Mountain Biking Activity</a>
            </div>
        </aside>
        <footer>
            <div>
