...
<html>
    ...
    <body>
        ...
        <main>
            <div>
                <img src="/rainier/media/images/rainier_hiking_guide_opt.jpg" alt="Hiking Guide" title="Jake Rammell">
        ...
        <aside>
            <div>
                <h3>Packages:</h3>
                <a href="/rainier/activities/hiking.php" title="Hiking Mount Rainier">Hiking Activity</a>
            </div>
        </aside>
        <footer>
            <div>
